...
function OK() {
  ...
  document.getElementById("checkshow1").innerHTML = `<a href="#" id="cancel" class="btn btn-outline-danger " style="margin-left: 20px;" onclick="Cancel()"><b>Quay Lại Giỏ Hàng</b></a>`
}
...
function Cancel() {
  ...
  document.getElementById("checkshow1").innerHTML = `<a href="home.html"  class="btn btn-outline-danger " style="margin-left: 20px;" onclick="Cancel()">Tiếp Tục Xem Sản Phẩm</a>`
}
...
function tttt() {
  ...
  if (showlogin == "") {
    ...
    document.getElementById("checkshow1").innerHTML = `<a href="home.html" id="cancel" class="btn btn-outline-danger " style="margin-left: 20px;"><b>Tiếp tục mua hàng</b></a>`
